...
static struct column_list const TABLE_BROWSER_EXTENSIONS[BROWSER_EXTENSIONS_FIELD_COUNT + 1] = {
    ...
    { .value = { FIELD_TEXT, 12, false, false, NULL, "package_profile_name", {.text = ""}, true}, .next = &TABLE_BROWSER_EXTENSIONS[12]},
    { .value = { FIELD_TEXT, 13, false, false, NULL, "package_profile_path", {.text = ""}, true}, .next = &TABLE_BROWSER_EXTENSIONS[13]},
    ...
    { .value = { FIELD_INTEGER, 21, false, false, NULL, "package_profile_referenced", {.integer = 0}, true}, .next = &TABLE_BROWSER_EXTENSIONS[21]},
